...
export default function NoraChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "model", text: "Hi there! I'm Nora, your personal travel assistant. How can I help you today?" }
  ]);
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-4 border-b border-cyan-400/20 bg-gradient-to-r from-midnight to-[#0a1229]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-display font-semibold text-ivory text-sm">Nora</h3>
              ...
              <div className="relative flex items-center gap-2">
                <div className="relative flex-1">
                  <input
                    ...
                    placeholder={isListening ? "Listening..." : "Ask Nora anything..."}
                ...
                <button
                  ...
                  title={isListening ? "Stop listening" : "Speak to Nora"}
                >
