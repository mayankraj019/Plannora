...
export default function GeneratingPage() {
  ...
  useEffect(() => {
    ...
    const generateTrip = async () => {
      ...
      // Use pre-selected geocoded coordinates if available, otherwise geocode CLIENT-SIDE
      const geoCoords = destination?.coordinates || await geocodeDestination(destName);
